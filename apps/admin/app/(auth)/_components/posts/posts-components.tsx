  ...
  return (
    <div className='m-8 lg:ml-[156px] lg:mr-[156px] '>
      <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center '>
        ...
        <div className='mt-4 ml-14 mr-4 flex flex-row items-center justify-end space-x-8 overflow-hidden max-w-full lg:invisible font-light text-sm text-neutral-200'>
          <PostFilterNavbar
            onSelectPostOption={handleSelectPostOption}
            postOption={postOption}
            onSelectTagOption={handleSelectTagOption}
